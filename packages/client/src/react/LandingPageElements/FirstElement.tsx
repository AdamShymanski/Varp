  ...
  return (
    <main className={`feWrapper `}>
      <article>
        ...
        <div className="body poppinsFont flexRow">
          <div>
            <p>
            ...
            <p>
              Current offers are around $1.5 for a survey that takes 20-30
              minutes to complete and the rewards are not paid in cash anyway,
              but e.g. in the form of vouchers to stores. This is terrible! Varp
              greatly reduces the time it takes to complete a task to receive a
              reward, and all money is paid out as a transfer to the user's bank
              account. Our model is based on adding an element of competition
              for the prize. The potential earnings of all users are added
              together and form a pool to be divided among several winners.
              Winners are determined through a game consisting of several
              smaller stages in which players play arcade games (Snake, Flappy
              Bird, Galaga, etc.). We chose this method of competition because
              it is relatively fair, interesting, engaging, and fun.
            </p>
            ...
            <p>
              ...
              share of the pot. It is worth reminding that to join the game it
              is enough to spend about 15 minutes.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                <p>
                  <span>- </span>You do not have to perform the same tedious
