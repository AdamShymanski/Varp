...
const handleCardsClass = (state: boolean) => {
  if (state) {
    return "card expanded";
  } else return "shrinked card ";
};
const changeCardsSize = (setFunction: Function) => {
  setFunction();
};
        ...
        <div className="bottom flexRow">
          <div className="bottom-container">
            <div id="landingCard_1" className={handleCardsClass(aState)}>
              ...
              <p className="bigDescription poppinsFont">
                This is my job, I'm looking for companys which want to
                colaborate with Pyramid. It's source of money for prizes for
                winners, but more on that later.
              </p>
              <img
                src={expandIcon}
                alt="Expand Icon"
                className="expandIcon"
                onClick={() => setA(aState => !aState)}
              />
              <img
                src={shrinkIcon}
                alt="Shrink Icon"
            ...
            <div id="landingCard_2" className={handleCardsClass(bState)}>
              ...
              <p className="bigDescription poppinsFont">
                ...
                their offer, as part of the task you could be requested to
                express your opinion about them, create an account on their
                website or just leave them your contact details. After
                completing the task, you receive tokens that will allow you to
                join the game. Remember that the amount tokens required to join
                the game is different each time, and largely depends on the pool
                of money allocated for the prize.
              </p>
              <img
                src={expandIcon}
                alt="Expand Icon"
                className="expandIcon"
                onClick={() => setB(bState => !bState)}
              />
              <img
                src={shrinkIcon}
                alt="Shrink Icon"
          ...
          <div className="bottom-container">
            <div id="landingCard_3" className={handleCardsClass(cState)}>
              ...
              <p className="bigDescription poppinsFont">
                The game is very simple, you need to score as many points as
                possible in mini-games. When finished, the scores are compared
                and the few people with the most points win the pot of money.
                Mini-games are usually arcade games, board games and other games
                of this type. The most important feature is their simplicity
              </p>
              <img
                src={expandIcon}
                alt="Expand Icon"
                className="expandIcon"
                onClick={() => setC(cState => !cState)}
              />
              <img
                src={shrinkIcon}
                alt="Shrink Icon"
            ...
            <div id="landingCard_4" className={handleCardsClass(dState)}>
              ...
              <p className="description poppinsFont">
                If you are among the winners, collect your prize in cash on the
                same day
              </p>
              <p className="bigDescription poppinsFont">
                The prize is a pool of money, usually around $300, if you find
                yourself in the group of winners you will receive cash in your
                bank account or PayPal. It is worth noting that you receive
                actual cash with your withdrawal, not gift cards or other such
                rewards.
              </p>
              <img
                src={expandIcon}
